...
public class RemoteControlFragment extends Fragment implements RemoteControlContract.View {
  ...
  @Inject public RemoteControlPresenter presenter;
  ...
  private void inject() {
    DemeterApplication.get(getContext())
        .getAppComponent()
        .plus(new RemoteControlModule(this))
        .injects(this);
  }
  ...
  public void setList(Demeter demeter) {
    ...
    RemoteControlListAdapter adapter =
        new RemoteControlListAdapter(
            getContext(),
            demeter,
